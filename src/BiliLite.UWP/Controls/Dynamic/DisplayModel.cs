...
namespace BiliLite.Controls.Dynamic
{
    public class DynamicItemDisplayModel : IModules
    {
        ...
        /// 是否显示稍后再看
        /// </summary>
        public bool ShowWatchLater
        { get { return Type == DynamicDisplayType.Video; } }
        ...
        public bool ShowDecorateText
        { get { return !string.IsNullOrEmpty(DecorateText); } }
        public string DecorateImage { get; set; }
        public bool ShowDecorate
        { get { return !string.IsNullOrEmpty(DecorateImage); } }
        ...
        { get { return $"https://t.bilibili.com/{DynamicID}"; } }
    }
